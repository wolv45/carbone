export function handleCLI(args: any[]): void;
export function loadTranslations(templatePath: string): void;
export function generateLang(dir: string, lang: string, callback: Function): any;
